...
const float p_o153793_gradient_0_pos = 0.022730602;
const float p_o153793_gradient_0_r = 0.372549027;
const float p_o153793_gradient_0_g = 0.341176480;
const float p_o153793_gradient_0_b = 0.309803933;
const float p_o153793_gradient_0_a = 1.000000000;
const float p_o153793_gradient_1_pos = 0.060609020;
const float p_o153793_gradient_1_r = 0.000000000;
const float p_o153793_gradient_1_g = 0.000000000;
const float p_o153793_gradient_1_b = 0.000000000;
const float p_o153793_gradient_1_a = 1.000000000;
const float p_o153793_gradient_2_pos = 0.294195002;
const float p_o153793_gradient_2_r = 0.670588255;
const float p_o153793_gradient_2_g = 0.321568638;
const float p_o153793_gradient_2_b = 0.211764708;
const float p_o153793_gradient_2_a = 1.000000000;
const float p_o153793_gradient_3_pos = 0.553033447;
const float p_o153793_gradient_3_r = 1.000000000;
const float p_o153793_gradient_3_g = 0.800000012;
const float p_o153793_gradient_3_b = 0.666666687;
const float p_o153793_gradient_3_a = 1.000000000;
vec4 o153793_gradient_gradient_fct(float x) {
  if (x < p_o153793_gradient_0_pos) {
    return vec4(p_o153793_gradient_0_r,p_o153793_gradient_0_g,p_o153793_gradient_0_b,p_o153793_gradient_0_a);
  } else if (x < p_o153793_gradient_1_pos) {
    return mix(vec4(p_o153793_gradient_0_r,p_o153793_gradient_0_g,p_o153793_gradient_0_b,p_o153793_gradient_0_a), vec4(p_o153793_gradient_1_r,p_o153793_gradient_1_g,p_o153793_gradient_1_b,p_o153793_gradient_1_a), ((x-p_o153793_gradient_0_pos)/(p_o153793_gradient_1_pos-p_o153793_gradient_0_pos)));
  } else if (x < p_o153793_gradient_2_pos) {
    return mix(vec4(p_o153793_gradient_1_r,p_o153793_gradient_1_g,p_o153793_gradient_1_b,p_o153793_gradient_1_a), vec4(p_o153793_gradient_2_r,p_o153793_gradient_2_g,p_o153793_gradient_2_b,p_o153793_gradient_2_a), ((x-p_o153793_gradient_1_pos)/(p_o153793_gradient_2_pos-p_o153793_gradient_1_pos)));
  } else if (x < p_o153793_gradient_3_pos) {
    return mix(vec4(p_o153793_gradient_2_r,p_o153793_gradient_2_g,p_o153793_gradient_2_b,p_o153793_gradient_2_a), vec4(p_o153793_gradient_3_r,p_o153793_gradient_3_g,p_o153793_gradient_3_b,p_o153793_gradient_3_a), ((x-p_o153793_gradient_2_pos)/(p_o153793_gradient_3_pos-p_o153793_gradient_2_pos)));
  }
  return vec4(p_o153793_gradient_3_r,p_o153793_gradient_3_g,p_o153793_gradient_3_b,p_o153793_gradient_3_a);
}
...
const float p_o8468_radius = 1.000000000;
...
vec4 o153793_0_1_rgba = o153793_gradient_gradient_fct((dot((o8469_0_2_rgba).rgb, vec3(1.0))/3.0));
vec2 o24085_2_uv = floor(((uv)*vec2(p_o24085_x, p_o24085_y)))+vec2(0.5);
vec3 o24085_2_dither = fract(vec3(dot(vec2(171.0, 231.0), o24085_2_uv))/vec3(103.0, 71.0, 97.0));
float o8468_0_4_f = shape_circle((o24085_2_uv/vec2(p_o24085_x, p_o24085_y)), p_o8468_sides, p_o8468_radius*1.0, p_o8468_edge*1.0);
vec3 o24085_0_3_rgb = floor(vec3(o8468_0_4_f)*p_o24085_c+p_o24085_d*(o24085_2_dither-vec3(0.5)))/p_o24085_c;

	vec3 albedo_tex = ((o153793_0_1_rgba).rgb).rgb;
	albedo_tex = mix(pow((albedo_tex + vec3(0.055)) * (1.0 / (1.0 + 0.055)),vec3(2.4)),albedo_tex * (1.0 / 12.92),lessThan(albedo_tex,vec3(0.04045)));
	float alpha = (dot(o24085_0_3_rgb, vec3(1.0))/3.0);
	COLOR = vec4(albedo_tex*vec4(p_o8456_albedo_color_r, p_o8456_albedo_color_g, p_o8456_albedo_color_b, p_o8456_albedo_color_a).rgb, alpha);
}
