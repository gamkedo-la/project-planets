...
const float p_o8468_radius = 1.00000000;
...
float o629459_3_1_f = o428250_0_3_rgba.a;
	...
	COLOR = vec4(albedo_tex*vec4(p_o8456_albedo_color_r, p_o8456_albedo_color_g, p_o8456_albedo_color_b, p_o8456_albedo_color_a).rgb, o629459_3_1_f);
